...
public:
	plenty();
	plenty(int, int k = 0); // для того, чтобы проходило plenty(size)
	plenty(const plenty&);
	~plenty(void);
...
int main()
{
	...
	plenty a(5);//создали вектор из 5 элементов, заполненный нулями 
	cout << "множество а: " << endl;
	cout<<a<<"\n";//вывели значения элементов вектора 
	cout << "Введите значения элементов множества: " << endl;
	...
	plenty b(5);//создали вектор из 5 элементов, заполненный нулями 
	cout << "множество b: " << endl;
	cout << b << "\n";//вывели значения элементов вектора 
	cout << "Введите значения элементов множества: " << endl;
	cin >> b;//ввели с клавиатуры значения элементов вектора 
	cout << "множество b: " << endl;
	cout << b << "\n";//вывели значения элементов вектора 
	...
	cout << "выводим значения элеменов множества a с помощью итератора" << endl;
	for (i = a.first(); i != a.last(); ++i) {
		cout << *i << " ";
	}
	cout << endl;
	//выводим предпоследнее значения элеменов вектора с помощью итератора
	cout << "выводим предпоследнее значения элеменов вектора с помощью итератора" << endl;
	i = a.last();
	--i; --i;
	cout << *i;
	return 0;
